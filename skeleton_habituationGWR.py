...
forgetflag = True #if true, it allows the model to simulate the process
#of forgetting the new paradigm/association that it learned
...
y = np.zeros((1,nTs)) #this is a row-vector... should it be column?
